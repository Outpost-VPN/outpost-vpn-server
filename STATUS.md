...
## Следующее исправление после 0.1.0-rc.14
...
Подготовлен fail-closed fix: Mihomo восстанавливает hostname из HTTP/TLS/QUIC,
...
диагностики не перезапускался и не изменялся.
