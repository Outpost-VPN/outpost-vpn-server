...
const titles: Record<Exclude<Locale, "ru">, Record<string, string>> = {
  en: {
    ...
    "connection.suspended": "Connection suspended",
    "connection.resumed": "Connection resumed",
  ...
  "zh-CN": {
    ...
    "connection.suspended": "已暂停连接",
    "connection.resumed": "已恢复连接",
  ...
  fa: {
    ...
    "connection.suspended": "اتصال به حالت تعلیق درآمد",
    "connection.resumed": "اتصال از سر گرفته شد",
