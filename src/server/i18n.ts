...
const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "Владелец уже создан — восстановление доступно только на чистой установке": "The owner already exists. Restore is available only on a clean installation.",
    "Восстановление уже выполняется": "A restore is already in progress.",
    "Резервная копия слишком большая": "The backup is too large.",
    "Не удалось прочитать резервную копию": "The backup could not be read.",
    "Выберите резервную копию Outpost": "Choose an Outpost backup.",
    "Выберите файл Outpost в формате .age или .tar": "Choose an Outpost .age or .tar file.",
    "Введите пароль резервной копии": "Enter the backup password.",
    "Резервная копия не прошла проверку — проверьте файл, домен и пароль": "The backup did not pass validation. Check the file, domain, and password.",
  ...
  "zh-CN": {
    ...
    "Владелец уже создан — восстановление доступно только на чистой установке": "所有者已存在；仅全新安装可执行恢复。",
    "Восстановление уже выполняется": "恢复已在进行中。",
    "Резервная копия слишком большая": "备份文件过大。",
    "Не удалось прочитать резервную копию": "无法读取备份文件。",
    "Выберите резервную копию Outpost": "请选择 Outpost 备份。",
    "Выберите файл Outpost в формате .age или .tar": "请选择 Outpost 的 .age 或 .tar 文件。",
    "Введите пароль резервной копии": "请输入备份密码。",
    "Резервная копия не прошла проверку — проверьте файл, домен и пароль": "备份未通过验证。请检查文件、域名和密码。",
  ...
  fa: {
    ...
    "Владелец уже создан — восстановление доступно только на чистой установке": "مالک از قبل وجود دارد؛ بازیابی فقط در نصب تمیز در دسترس است.",
    "Восстановление уже выполняется": "بازیابی دیگری در حال انجام است.",
    "Резервная копия слишком большая": "فایل پشتیبان بیش از حد بزرگ است.",
    "Не удалось прочитать резервную копию": "خواندن فایل پشتیبان ممکن نشد.",
    "Выберите резервную копию Outpost": "یک فایل پشتیبان Outpost انتخاب کنید.",
    "Выберите файл Outpost в формате .age или .tar": "یک فایل Outpost با قالب .age یا .tar انتخاب کنید.",
    "Введите пароль резервной копии": "رمز پشتیبان را وارد کنید.",
    "Резервная копия не прошла проверку — проверьте файл, домен и пароль": "پشتیبان تأیید نشد؛ فایل، دامنه و رمز را بررسی کنید.",
...
const codes: Record<string, string> = {
  ...
  "Владелец уже создан — восстановление доступно только на чистой установке": "restore.owner_exists",
  "Восстановление уже выполняется": "restore.in_progress",
  "Резервная копия слишком большая": "restore.too_large",
  "Не удалось прочитать резервную копию": "restore.unreadable",
  "Выберите резервную копию Outpost": "restore.file_required",
  "Выберите файл Outpost в формате .age или .tar": "restore.format_invalid",
  "Введите пароль резервной копии": "restore.password_required",
  "Резервная копия не прошла проверку — проверьте файл, домен и пароль": "restore.validation_failed",
...
const presentationMessages: Record<Exclude<Locale, "ru">, Record<string, string>> = {
  en: {
    ...
    "Во время перезапуска панель ненадолго станет недоступна": "The panel will be briefly unavailable while Outpost restarts",
  ...
  "zh-CN": {
    ...
    "Во время перезапуска панель ненадолго станет недоступна": "Outpost 重启期间，面板将短暂不可用",
  ...
  fa: {
    ...
    "Во время перезапуска панель ненадолго станет недоступна": "هنگام راه‌اندازی مجدد Outpost، پنل برای مدت کوتاهی در دسترس نخواهد بود",
