...
> **Status:** `0.1.0-rc.20` pre-release. Local tests and production builds pass;
...
```bash
curl -fsSLo /tmp/outpost-install https://raw.githubusercontent.com/Outpost-VPN/outpost-vpn-server/main/infra/scripts/bootstrap && sudo env OUTPOST_VERSION=0.1.0-rc.20 bash /tmp/outpost-install
```
