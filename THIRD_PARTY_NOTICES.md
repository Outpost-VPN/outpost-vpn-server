...
Matreshka распространяется по AGPL-3.0-only. Следующие непосредственно используемые проекты сохраняют собственные лицензии и copyright notices:

| Компонент | Версия в v1 | Лицензия |
|---|---:|---|
| Bun | 1.3.13 | MIT |
| Imba | 2.0.0 nightly | MIT |
| bimba-cli | 0.2.9 | MIT |
| Model Context Protocol TypeScript SDK | 1.30.0 | MIT |
...
| age Go library / CLI | 1.3.1 | BSD-3-Clause |
